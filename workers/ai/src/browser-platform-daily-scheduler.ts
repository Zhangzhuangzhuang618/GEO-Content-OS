...
async function createCandidate(
  ...
  const platformInstruction =
    batch.platformCode === 'lieju'
      ? '标题保持5-30字并以用户问题或解决方法为中心，自然使用“如何、怎么、指南、方法、哪些”等问法之一。允许明确介绍本企业服务范围、流程、可核验能力和适用场景，自然提示通过页面联系方式咨询，并保留与正文相关的外部网址或官方核验链接；品牌、事实和资质表述必须与当前企业资料及引用证据一致。只有 brief.constraints.enterprise_evidence 存在时，服务器才会确定性插入一次资质保障段落，模型不得重复罗列或改写该资料清单；不存在时不得补造资质、认证、保险或赔付事实。正文不得出现具体电话或手机号、微信/QQ账号、极限词、排名、竞品贬损、虚假价格、虚假资质、虚构案例、客户评价、结果保证或内部风控话术。'
      : batch.platformCode === 'douyin'
