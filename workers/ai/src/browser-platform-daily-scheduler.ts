  ...
  const platformInstruction =
    batch.platformCode === 'lieju'
      ...
      : batch.platformCode === 'douyin'
        ? '输出抖音图文笔记：platform_meta.content_kind 必须是 image_note；生成6-9张图文卡片，顺序为封面、正文、总结。卡片按主题痛点、现场核对、报价或服务边界、防护风险、预约工期、实操清单和结论推进，正文每页只讲一个判断或动作并控制在24-88字，禁止长段拆页、模板标题和同义重复。同时提供420-900字、5-8个自然段的独立发布主文案：首段两句完成点题和痛点，第二至第三段给解决方案并在资料支持时自然提及一次本企业全称，随后讲清费用边界、防护风险和工期安排，倒数第二段至少3条编号避坑点，最后给选择依据；不得复制摘要、正文块或卡片，不得使用模板钩子和助手过渡语。topics 使用3-8个紧贴地域、场景和服务对象的话题。不得声明原创、不得伪造热点、排行、亲历、用户评价或无证据资质；发布器会如实勾选 AI 创作标识。'
