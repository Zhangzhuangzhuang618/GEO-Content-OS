...
export const operations = {
  ...
  account_list: {
    ...
    permission: 'content.production.manage|publishing.manage',
    security: 'session',
  },
  account_create: {
    idempotency: 'key+body_hash',
  ...
  account_content_policy_get: {
    idempotency: '-',
    method: 'GET',
    path: '/platform-accounts/{id}/content-policy',
    permission: 'publishing.manage',
    security: 'session',
  },
  account_content_policy_put: {
    idempotency: 'key+body_hash',
    method: 'PUT',
    path: '/platform-accounts/{id}/content-policy',
    permission: 'publishing.manage',
