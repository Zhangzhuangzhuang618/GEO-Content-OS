...
export const BaijiahaoDeliveryConfigSchema = z.discriminatedUnion('mode', [
...
export type BaijiahaoDeliveryConfig = z.infer<typeof BaijiahaoDeliveryConfigSchema>;

export function parseBaijiahaoDeliveryConfig(input: unknown): BaijiahaoDeliveryConfig {
  return BaijiahaoDeliveryConfigSchema.parse(input);
}
