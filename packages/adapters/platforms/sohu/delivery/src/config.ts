...
export const SohuDeliveryConfigSchema = z.discriminatedUnion('mode', [
...
export type SohuDeliveryConfig = z.infer<typeof SohuDeliveryConfigSchema>;

export function parseSohuDeliveryConfig(input: unknown): SohuDeliveryConfig {
  return SohuDeliveryConfigSchema.parse(input);
}
