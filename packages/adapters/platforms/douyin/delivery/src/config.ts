...
export const DouyinDeliveryConfigSchema = z.discriminatedUnion('mode', [
...
export type DouyinDeliveryConfig = z.infer<typeof DouyinDeliveryConfigSchema>;

export function parseDouyinDeliveryConfig(input?: unknown): DouyinDeliveryConfig {
  return DouyinDeliveryConfigSchema.parse(input ?? { mode: 'export_only' });
}
