...
export const ZhihuDeliveryConfigSchema = z.discriminatedUnion('mode', [
...
export type ZhihuDeliveryConfig = z.infer<typeof ZhihuDeliveryConfigSchema>;

export function parseZhihuDeliveryConfig(input: unknown): ZhihuDeliveryConfig {
  return ZhihuDeliveryConfigSchema.parse(input);
}
