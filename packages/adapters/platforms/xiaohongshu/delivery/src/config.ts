...
export const XiaohongshuDeliveryConfigSchema = z.discriminatedUnion('mode', [
...
export type XiaohongshuDeliveryConfig = z.infer<typeof XiaohongshuDeliveryConfigSchema>;

export function parseXiaohongshuDeliveryConfig(input?: unknown): XiaohongshuDeliveryConfig {
  return XiaohongshuDeliveryConfigSchema.parse(input ?? { mode: 'export_only' });
}
