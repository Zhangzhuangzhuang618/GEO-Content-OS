...
export const ToutiaoDeliveryConfigSchema = z.discriminatedUnion('mode', [
...
export type ToutiaoDeliveryConfig = z.infer<typeof ToutiaoDeliveryConfigSchema>;

export function parseToutiaoDeliveryConfig(input: unknown): ToutiaoDeliveryConfig {
  return ToutiaoDeliveryConfigSchema.parse(input);
}
