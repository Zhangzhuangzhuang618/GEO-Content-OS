...
import type { PlatformConfigApiContract } from './index.js';

export function buildPlatformConfigOpenApiDocument(
  contracts: readonly PlatformConfigApiContract[],
) {
  ...
  return Object.freeze({
    ...
    info: { title: 'GEO Content OS Platform Config API', version: '2.1.0' },
