...
import {
  ...
  AiVisibilityQuerySetListResponseSchema,
  AiVisibilityQuerySetResponseSchema,
  AiVisibilityRunCreateResponseSchema,
  AiVisibilityRunCreateSchema,
  AiVisibilityRunDetailQuerySchema,
  AiVisibilityRunDetailResponseSchema,
  AiVisibilityRunListQuerySchema,
  AiVisibilityRunListResponseSchema,
...
const contracts = [
  ...
  contract(
    'ai-visibility.query-set.create',
    'POST',
  ...
  contract(
    'ai-visibility.run.detail',
    'GET',
    '/ai-visibility/runs/{id}',
    'analyst_or_admin',
    'analytics.read',
    '-',
    null,
